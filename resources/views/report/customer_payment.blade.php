...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="text-center">
                {!! Form::open(array('url' => 'report/customer_payment', 'class' => 'form')) !!}
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">รายได้ทั้งหมด แบ่งเป็นประเภทการชำระเงิน</h3>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border" align="middle">
                    ...
                    {!! Form::open(array('url' => 'report/customer_payment?type=excel', 'class' => 'form')) !!}
