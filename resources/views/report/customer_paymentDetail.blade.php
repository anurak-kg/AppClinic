    ...
    <div class="box">
        <div class="box-header with-border" align="middle">
            ...
            <div class="box-tools pull-right">
                ...
                <a class="btn btn-warning" href="{{url('report/customer_paymentGraphic')}}">{{trans('report.graph')}}</a>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 table-responsive">
                    <table class="table table-bordered">
                        <thead>
                        <tr>
                            <td align="middle"><b>{{trans('report.payment_type')}}</b></td>
                            <td align="middle"><b>{{trans('report.income')}}</b></td>
                        </tr>
                        </thead>
