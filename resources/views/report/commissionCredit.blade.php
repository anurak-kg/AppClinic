...
@section('title','Commission Credit')
@section('content')

    <div class="row">
        <div class="col-md-12">
            <p class="text-center">
                {!! Form::open(array('url' => 'report/commissionCredit', 'class' => 'form')) !!}
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Commission Credit</h3>
                ...
                <div class="box-header with-border" align="middle">
                    <h2 class="box-title">ตารางสรุปข้อมูล</h2>
                      <span class="pull-right">
                         {!! Form::open(array('url' => 'report/commissionCredit?type=excel', 'class' => 'form')) !!}
