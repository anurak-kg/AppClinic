...
@section('content')
    ...
    <p class="text-center">
        {!! Form::open(array('url' => 'report/commisstionDetail', 'class' => 'form')) !!}
    ...
    <div class="box">
        <div class="box-header with-border" align="middle">
            ...
            <div class="box-tools pull-right">
                ...
                <a class="btn btn-warning" href="{{url('report/commisstionGraphic')}}">{{trans('report.graph')}}</a>
            </div>
        ...
        <div class="box-body" id="datatable">
                   ...
                   <span class="pull-right">
                    {!! Form::open(array('url' => 'report/commisstionDetail?type=excel', 'class' => 'form')) !!}
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($data as $test)
                            <tr>
                                ...
                                <td align="middle"
                                    style="width: 850px;"><?php echo number_format($test->Total)?> {{trans('report.baht')}}</td>
                            </tr>
                        @endforeach
                    </table>
                </div>
