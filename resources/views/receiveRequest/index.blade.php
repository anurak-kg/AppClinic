...
@section('headText','รับยาเข้าสาขา')
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading with-border">
                                        <h2 class="panel-title"><i class="fa fa-user"></i> พนักงานส่งยา </h2>
                                    </div>
                                    <div class="panel-body">
                                        <div class="form-group vendorSearchBox">
                                        <label class="col-sm-4 control-label">พนักงานส่งยา</label>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading with-border">
                                    <h2 class="panel-title"><i class="fa fa-user"></i> พนักงานรับยา </h2>
                                </div>
                                <div class="panel-body">
                                    <div class="form-group vendorSearchBox">
                                    <label class="col-sm-4 control-label">พนักงานรับยา</label>

                                    <div class="col-sm-8">
                                        <input class="form-control typeahead  order-input "
                                               type="search"
                                               placeholder="พนักงานรับยา"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading with-border">
                                <h2 class="panel-title">เลขที่ใบส่งยา </h2>
                            </div>
                            <div class="panel-body">
                                ...
                                {{--</div>--}}
                                <div class="form-group vendorSearchBox">
                                    <label class="col-sm-4 control-label">เลขที่ใบส่ง</label>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading with-border">
                                <h2 class="panel-title"> เลขที่ใบเบิกยา </h2>
                            </div>
                            <div class="panel-body">
                                {{--<div class="form-group" style="margin-bottom: 40px;">--}}
                                {{--<label class="col-sm-4 control-label">คลังสินค้า</label>--}}
                                ...
                                {{--</div>--}}
                                <div class="form-group vendorSearchBox">
                                    <label class="col-sm-4 control-label">เลขที่ใบเบิก</label>
