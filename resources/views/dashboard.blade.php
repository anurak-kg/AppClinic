    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-blue">
                ...
                <a href="{{url('customer/create')}}" class="small-box-footer">สมัครสมาชิก <i
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="{{url('quotations')}}" class="small-box-footer">ซื้อคอร์ส <i
                            class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="{{url('product_detail/index')}}" class="small-box-footer">ซื้อสินค้า <i
                            class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="{{url('treatment')}}" class="small-box-footer">รักษา <i
                            class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
            ...
            <div class="box box-solid box-default">
                ...
                <div class="box-footer no-padding">
                    <ul class="nav nav-pills nav-stacked">
                        <li><a href="#">MELASMA WHITENING<span class="pull-right text-red"><i
                                            class="fa fa-angle-down"></i> 30%</span></a></li>
                        <li><a href="#">ACNE <span class="pull-right text-green"><i
                                            class="fa fa-angle-up"></i> 20%</span></a></li>
                        <li><a href="#">AGE REVERSE <span class="pull-right text-yellow"><i
                                            class="fa fa-angle-left"></i> 20%</span></a></li>
                        <li><a href="#">VELA BODY <span class="pull-right text-yellow"><i class="fa fa-angle-left"></i> 30%</span></a>
                        </li>
                    </ul>
                </div>
                <!-- /.footer -->
